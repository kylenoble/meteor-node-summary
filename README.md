...
It is a meteor wrapper of [Node Summary](https://github.com/jbrooksuk/node-summary) by [jbrooksuk](http://www.github.com/jbrooksuk).

[![Build Status](https://travis-ci.org/kylenoble/meteor-node-summary.png)](https://travis-ci.org/kylenoble/meteor-node-summary)
...
```
    meteor add kylenoble:MeteorNodeSummary
```
...
Tests are conducted using [tinytest](https://npmjs.org/package/tint)
